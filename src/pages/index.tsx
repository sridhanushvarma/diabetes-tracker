    ...
    <ThemeLayout title="Home">
      <div className="max-w-4xl mx-auto">
        <section className="text-center py-12">
          <h1 className={`text-4xl font-bold mb-4 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Track Your Diabetes Journey</h1>
          <p className={`text-xl mb-8 ${isDark ? 'text-gray-400' : 'text-gray-700'}`}>
        ...
        <section className="py-12">
          <h2 className={`text-3xl font-bold text-center mb-8 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Key Features</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Easy Data Entry</h3>
            ...
            <div className="card text-center">
              ...
              <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Long-term Storage</h3>
              <p className={isDark ? 'text-gray-400' : 'text-gray-700'}>
            ...
            <div className="card text-center">
              ...
              <h3 className={`text-xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Insightful Analytics</h3>
              <p className={isDark ? 'text-gray-400' : 'text-gray-700'}>
        ...
        <section className="py-12">
          <h2 className={`text-3xl font-bold text-center mb-8 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>How It Works</h2>

          <div className="space-y-8">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 p-4">
                <h3 className={`text-2xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>1. Record Your Readings</h3>
                <p className={isDark ? 'text-gray-400' : 'text-gray-700'}>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 p-4 order-1 md:order-2">
                <h3 className={`text-2xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>2. View Your Dashboard</h3>
                <p className={isDark ? 'text-gray-400' : 'text-gray-700'}>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 p-4">
                <h3 className={`text-2xl font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>3. Generate Reports</h3>
                <p className={isDark ? 'text-gray-400' : 'text-gray-700'}>
